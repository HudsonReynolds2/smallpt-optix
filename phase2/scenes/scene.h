...
// gaps at the seams between adjacent walls. Two problems followed:
//
//   1. At resolutions wider than ~4:3, the camera frustum extends laterally
//      past the room walls. Primary rays at the corners exit the room
//      sideways before hitting any wall and then strike the radius-600 light
//      sphere that extends far above the ceiling -> bright white wedges in
//      the top corners of the image.
//
//   2. Secondary bounces near wall seams can also escape and find the light
//      sphere -> ghost rings on the back wall, contaminated reflections in
//      the glass and mirror spheres.
//
...
// camera-frustum escape (the worst extreme corner ray at 16:9/1080p is ~10
// units outside the room laterally) and every secondary-bounce escape, while
...
static const WallDef g_walls[] = {
    ...
    // This is the critical one: the unextended ceiling was the main escape
    // path for rays heading up-and-outward.
