...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        OptixProgramGroup rg_pg = nullptr, ms_pg = nullptr, ch_pg = nullptr;
        {
            ...
            OPTIX_CHECK_LOG(optixProgramGroupCreate(context, &rg_desc, 1, &pg_opts,
                            log, &log_size, &rg_pg));
            ...
            OPTIX_CHECK_LOG(optixProgramGroupCreate(context, &ms_desc, 1, &pg_opts,
                            log, &log_size, &ms_pg));
            ...
            OPTIX_CHECK_LOG(optixProgramGroupCreate(context, &ch_desc, 1, &pg_opts,
                            log, &log_size, &ch_pg));
        }
        ...
        OptixPipeline pipeline = nullptr;
        {
            ...
            OPTIX_CHECK(optixUtilComputeStackSizes(&stack_sizes, 2, 0, 0,
